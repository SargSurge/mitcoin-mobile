...
export default class Charity extends React.Component {
  ...
  async updateCharity() {
    ...
    let response = await fetch(WEB_URL + "api/charity-selection", {
      method: "POST",
        ...
        <Content>
          <Text>
            {charity === ""
              ...
              : "Your MITcoins will be donated to " +
                charity +
                ". You can select another one from below."}
          </Text>
          ...
          <ListItem onPress={() => this.toggleRadio("foodForFree")}>
            ...
            <Right>
              <Radio
                onPress={() => this.toggleRadio("foodForFree")}
                selected={this.state.foodForFree}
              />
            </Right>
          </ListItem>
          <ListItem onPress={() => this.toggleRadio("onTheRise")}>
            ...
            <Right>
              <Radio
                onPress={() => this.toggleRadio("onTheRise")}
                selected={this.state.onTheRise}
              />
            </Right>
          </ListItem>
          <ListItem onPress={() => this.toggleRadio("shrinerHospital")}>
            ...
            <Right>
              <Radio
                onPress={() => this.toggleRadio("shrinerHospital")}
                selected={this.state.shrinerHospital}
              />
            </Right>
          </ListItem>
