...
export default class Vote extends React.Component {
  ...
  render() {
    return (
      <Container>
        <Header navigation={this.props.navigation} title="Vote" />
        <Content style={{ paddingTop: 10 }}>
          <Text style={{ alignSelf: "center" }}>
            {this.state.selected
              ? "Your selected charity is:"
          ...
          >
            ...
            <Picker.Item
              label="Somerville-Cambridge Elder Services"
              value="key6"
            />
            ...
            <Picker.Item
              label="Cambridge Public Library Literacy Project"
              value="key10"
            />
            <Picker.Item
              label="International Institute of New England"
              value="key11"
            />
            <Picker.Item
              label="New England Center for Homeless Veterans"
              value="key12"
            />
          </Picker>
        </Content>
